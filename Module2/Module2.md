...
1. Download exercises-applied-part1.zip
2. In CMD

```
unzip exercises-applied-part1.zip
cd exercises-applied
```
3. Import buidl.sbt into IntelliJ

```
#Compile Project
sbt test:Compile
```
![alt text](/Images/Module2/ProjectCompile.JPG)  
...
```
![alt text](/Images/Module2/ExerciseTest.JPG)
